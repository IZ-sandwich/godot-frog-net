...
/// <summary>
/// S3-SingleCubePushMagnitudeAdaptive — identical setup to
/// <see cref="S3SingleCubePush"/>, but flips every smoother on the client
/// to <c>PredictionVisualSmoothing3D.PosDecayMode.MagnitudeAdaptive</c>
/// via the <c>smoother-decay-mode</c> harness command after spawn-settle.
/// Used to compare Fusion 2-style magnitude-adaptive decay against the
/// legacy Exponential and the Q3-style Linear modes in a single matrix
/// run.
/// </summary>
public sealed class S3SingleCubePushMagnitudeAdaptive : IScenario
{
    public string Id => "S3-SingleCubePushMagAdaptive";
